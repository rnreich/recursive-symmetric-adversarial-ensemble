...
__The variable wake being set to True causes a sudden reset of all training variables, along with the high gate errors being entered into the recursive cycle.__
