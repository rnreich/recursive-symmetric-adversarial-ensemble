    ...
    with open(DATA_FILE, "r") as csvfile: 
        ...
        for row in datareader:
            if data_row_index>0 and np.random.rand()<DATA_USE_PERCENT:
                ...
                synapses[target_synapse][COMP_PROJ1].fit(x=enc_train_x, y=targets, epochs=EPOCHS_PER_FIT*2, batch_size=1, verbose=0)
                synapses[target_synapse][COMP_PROJ2].fit(x=dec_train_x, y=targets, epochs=EPOCHS_PER_FIT*2, batch_size=1, verbose=0)
                ...
                intelligence_signal = beststreak_odds/cycles*ssr/(1-diff)
                ...
                synapses[target_synapse][COMP_PROJ1].fit(x=latent, y=flags, epochs=EPOCHS_PER_FIT*2, batch_size=1, verbose=0)
                synapses[target_synapse][COMP_PROJ2].fit(x=dec, y=flags, epochs=EPOCHS_PER_FIT*2, batch_size=1, verbose=0)
